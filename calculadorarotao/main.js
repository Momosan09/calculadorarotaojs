...
let getData = function(){
    ...
    let Second = parseInt( document.getElementById("second").checked);       //Llama a "second" y lo asigna a la variable Second (".value" sirve para asignar el valor a la variable)
